...
// Write a program to draw a Cuboid of 2x3x6 dimentions. The
// cuboid can be represented graphically, or in ASCII art. To
// fulfill the criteria of being a cuboid, three faces must
// be visible.
func main() {
